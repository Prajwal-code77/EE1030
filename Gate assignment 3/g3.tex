...
\item 11 
    ...
    \input{figures/471.tex}
    Assuming forward voltage drops of the diodes to be 0.7 V, the input-output transfer characteristics of the circuit is

 \begin{enumerate}
 \newpage
\item \input{figures/4711.tex}
\newpage
\item \input{figures/4712.tex}
\newpage
\item \input{figures/4713.tex}

\item \input{figures/4714.tex}
            \end{enumerate}
